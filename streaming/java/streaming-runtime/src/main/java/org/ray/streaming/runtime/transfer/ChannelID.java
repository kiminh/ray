...
public class ChannelID {
  ...
  public static String genIdStr(int fromTaskId, int toTaskId, long ts) {
    ...
    */
    Preconditions.checkArgument(fromTaskId < Integer.MAX_VALUE,
        "fromTaskId %d is larger than %d", fromTaskId, Integer.MAX_VALUE);
    Preconditions.checkArgument(toTaskId < Integer.MAX_VALUE,
        "toTaskId %d is larger than %d", fromTaskId, Integer.MAX_VALUE);
