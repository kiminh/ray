...
public class Log4jUtils {
  ...
  private static FileWriter createWriter(String fileName) {
    ...
    return writers.computeIfAbsent(fileName, new Function<String, FileWriter>() {
      @Override
  ...
  public static void initLog4jLogger(Class clazz, String loggerFileName, int maxBackupIndex,
