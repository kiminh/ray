...
class FailureDetector {
 ...
 public:
  ...
  ip::detail::endpoint GetMasterEndpoint() const {
    if (master_) {
      return master_->endpoint;
    }
    return ip::detail::endpoint();
  }
  ...
  ip::detail::endpoint GetPrimaryEndpoint() const { return primary_endpoint_; }
